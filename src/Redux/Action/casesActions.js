...
export const listCases = () => async (dispatch, getState) => {
  try {
    ...
    const { data } = await axios.get("https://voixbdd.onrender.com/api/case", config);
...
export const listMyCases = () => async (dispatch, getState) => {
  try {
    ...
    const { data } = await axios.get(`https://voixbdd.onrender.com/api/case/mescas`, config);
...
export const createCase = (formData) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.post("https://voixbdd.onrender.com/api/case", formData, config);
...
export const getCaseEvolution = (caseId) => async (dispatch, getState) => {
  try {
    ...
    const { data } = await axios.get(`https://voixbdd.onrender.com/api/case/${caseId}`, config);
 ...
 export const addCaseEvolution = (caseId, evolutionData) => async (dispatch, getState) => {
  try {
    ...
    const { data } = await axios.put(
      `https://voixbdd.onrender.com/api/case/${caseId}/evolution`,
      evolutionData,
      config
    );
...
export const listAllCases = () => async (dispatch, getState) => {
  try {
    ...
    const { data } = await axios.get("https://voixbdd.onrender.com/api/case/all", config);
